...
$hostpoolMetadataRegion = Get-AutomationVariable -Name 'hostpoolMetadataRegion' # Added by Matt
...
$body = @"
{
  "parameters": {
    "gitSource": {
      "url": "https://github.com/ISMDemocom/wvdquickstart.git"
    }
  }
}
"@
...
$parameters = $parameters.Replace("[hostpoolMetadataRegion]", $hostpoolMetadataRegion)
